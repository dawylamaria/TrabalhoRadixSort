...
void countingSort(int vetor[], int tamanho, int div){
	...
	// isso ? feito para determinar os ?ndices do vetor saida
	for(int i = 1; i<10; i++){
		count[i] += count[i-1];
	}
	
	// os numeros vao sendo inseridos no vetor de saida na posi??o correspondente ao valor acumulado do contador
